...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "game.Game": {
            ...
            "properties": {
                "available_pieces": {
                    "description": "JSON array of piece IDs",
                    "type": "string"
                },
                "board": {
                    "description": "JSON serialized 4x4 board",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
                ...
                "game_phase": {
                    "description": "\"selectPiece\" | \"placePiece\"",
                    "type": "string"
                },
                "id": {
                    "type": "string"
                ...
                "move_history": {
                    "description": "JSON array of moves in notation",
                    "type": "string"
                },
                "player1_id": {
                    "type": "integer"
                ...
                "selected_piece": {
                    "description": "Current piece ID to place",
                    "type": "integer"
                },
                "status": {
                ...
                "winner": {
                    "description": "\"player1\" | \"player2\" | \"draw\"",
                    "type": "string"
                }
            }
        },
